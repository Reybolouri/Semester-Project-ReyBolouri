...
st.subheader("Comparison of Weekly Hours and Hourly Earnings Over Time")

# Ensure the 'date' column is in datetime format
data['date'] = pd.to_datetime(data['date'])

# Sidebar filters for date range
st.sidebar.header("Filters for Weekly Hours and Hourly Earnings")
...
# Add "Average Weekly Hours" as an area plot
fig.add_trace(
    go.Scatter(
        x=merged_data['date'],
        y=merged_data['avg_weekly_hours'],
...
# Add "Average Hourly Earnings" as an area plot
fig.add_trace(
    go.Scatter(
        x=merged_data['date'],
        y=merged_data['avg_hourly_earnings'],
        mode='lines',
        fill='tonexty',  # Fill area to the previous trace
        name="Average Hourly Earnings",
...
# Customize layout
fig.update_layout(
    title="Comparison of Weekly Hours and Hourly Earnings",
    xaxis=dict(
        title="Date",
        showgrid=True,
        gridcolor='lightgray',
