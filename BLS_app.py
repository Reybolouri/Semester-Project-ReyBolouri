...
st.markdown(
    ...
    <div style="text-align: center; padding: 10px 0;">
        <h1 style="color:#0288D1;">US Labor Market</h1>
        <p style="color:gray;">Unemployment and Labor trends over the years. Data sourced from the [Bureau of Labor Statistics](https://www.bls.gov/home.htm).</p>
    </div>
    """,
